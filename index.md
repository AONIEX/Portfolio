...
<div style="text-align:center; padding: 3em 1em; background: linear-gradient(135deg, #00aaff, #004466); color: white;">
  ...
  <div style="margin-top: 2em;">
    <a href="/Portfolio/projects/" style="background:#fff; color:#004466; padding:0.8em 1.5em; border-radius:6px; text-decoration:none; font-weight:bold;">View My Projects</a>
...
<div style="display:flex; flex-wrap:wrap; gap:1em; justify-content:center; margin-top:1em;">
  ...
  <img width="315" height="250" alt="Corgi" src="Assets/Corgi.png" />
</div>
